...
async def start(client,message):
	...
	**Document Or Video** and enter new filename to rename it__
	...
	reply_markup=InlineKeyboardMarkup(
	 [[ InlineKeyboardButton("Support 🙇🏻‍♂️" ,url="https://t.me/Otaku_Chats") ], 
	[InlineKeyboardButton("Subscribe ✌🏻", url="https://t.me/TheBotsLibrary") ]  ]))
	    return
	if id:
	    if old == True:
	        try:
	...
	**Document Or Video** and enter new filename to rename it__
	""",reply_to_message_id = message.id ,  
	reply_markup=InlineKeyboardMarkup(
	 [[ InlineKeyboardButton("Support ✌🏻" ,url="https://t.me/Otaku_Chats") ], 
	[InlineKeyboardButton("Subscribe 🙇🏻‍♂️", url="https://t.me/TheBotsLibrary") ]  ]))
	        except:
	             return
	    else:
